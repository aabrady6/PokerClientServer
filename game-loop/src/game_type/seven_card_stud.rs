...
//            return self.determine_lowest_door() as usize;
//        } else {
//            return self.determine_highest_door() as usize;
//        }
//    }
//
...
//            self.deal_face_up(1);
//
//            starting_index = self.determine_lowest_door() as usize;
//            self.betting_round(starting_index, self.lower_bet).await;
//
//            self.deal_face_up(1);
//            starting_index = self.determine_highest_door() as usize;
