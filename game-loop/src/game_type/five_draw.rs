...
//        }
//
//        self.game_state.betting_loop(starting_index, None).await;
//    }
//
...
//    //}
//    //
//    pub async fn get_card_idxs_to_discard(&self) -> Vec<u8> {
//        self.game_state.trigger_broadcast();
//        Vec::new()
//    }
//
...
//    /// ```
//    async fn player_redraw(&mut self) {
...
//                break;
//            }
//            let mut player = self.game_state.players()[player_search as usize].clone();
//
//            let action_string =
//                format!("Player {}: choosing cards to discard...", player.get_name());
//            self.game_state
//                .set_current_action_string(action_string.clone());
//            self.game_state.append_action_history(action_string.clone());
//            self.game_state.trigger_broadcast();
//
//            // for player in &mut self.game_state.players {
//            if !player.player_choices.contains_key("Fold") {
...
//                    // }
//
//                    let mut discard_indices = self.get_card_idxs_to_discard().await;
//
...
//                            "Player {}: Please choose cards to discard!",
//                            player.get_name()
//                        );
//                        self.game_state
//                            .set_current_action_string(action_string.clone());
...
//                            let action_string =
//                                format!("Player {} discarded 0 cards.", player.get_name());
//                            self.game_state
//                                .set_current_action_string(action_string.clone());
//                            self.game_state.append_action_history(action_string.clone());
//                            self.game_state.trigger_broadcast();
...
//                        } else {
//                            let action_string = format!("Player {}: Please choose cards to discard; cannot choose 0 and a value of cards to discard.", player.get_name());
//                            self.game_state
//                                .set_current_action_string(action_string.clone());
//                            self.game_state.append_action_history(action_string.clone());
//                            self.game_state.trigger_broadcast();
...
//                            let action_string = format!(
//                                "Player {}: Please choose only up to cards to discard.",
//                                player.get_name()
//                            );
//                            self.game_state
//                                .set_current_action_string(action_string.clone());
...
//                            let action_string = format!(
//                                "Player {}: Please only choose valid cards to discard.",
//                                player.get_name()
//                            );
//                            self.game_state
//                                .set_current_action_string(action_string.clone());
...
//                            let action_string = format!(
//                                "Player {}: Please only non-duplicate cards to discard.",
//                                player.get_name()
//                            );
//                            self.game_state
//                                .set_current_action_string(action_string.clone());
...
//                            }
//                            let action_string =
//                                format!("Player {}: Received new cards.", player.get_name());
//                            self.game_state
//                                .set_current_action_string(action_string.clone());
//                            self.game_state.append_action_history(action_string.clone());
//                            self.game_state.trigger_broadcast();
