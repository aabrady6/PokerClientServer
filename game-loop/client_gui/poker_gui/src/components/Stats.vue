<template>
  <div class="stats_container">
    ...
    <div v-if="statsMenuType === 'root'" class="stats_options">
      <div class="control_button" @click="onClick('PlayerStats')">
        Player stats
      </div>
      <div class="control_button" @click="onClick('GameStats')">Game stats</div>
    </div>
    <table v-if="statsMenuType === 'player'" class="player_stats">
      <thead>
        <tr>
          <th
      ...
      <tbody>
        ...
        >
          <td v-for="(value, key) in data" :key="key" class="player_stats_cell">
            {{ value }}
          </td>
        </tr>
      </tbody>
    </table>
    <table v-if="statsMenuType === 'games'" class="games_stats">
      <thead>
        <tr>
          <th
      ...
      <tbody>
        ...
        >
          <td v-for="(value, key) in data" :key="key" class="games_stats_cell">
            {{ value }}
          </td>
        </tr>
      </tbody>
    </table>
    <table v-if="statsMenuType == 'single_game'" class="single_game_stats">
      <thead>
        <tr>
          <th
